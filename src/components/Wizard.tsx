...
import { AddImageToService, AddService, GetAllCities, GetAllService, GetAllYachts, GetCurrency, GetFeildsbysid, GetPlacesbyid, GetResidencebyCottages} from "../Services";
