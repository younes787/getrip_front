  ...
  return (
    ...
    {loading? <LoadingComponent/>:  <div>
        ...
        <DataTable
          ...
          sortMode="multiple"
        >
          <Column field="name" filter sortable header="Province Name"></Column>
          <Column
            field=""
            sortable
            header="Actions"
          ...
          <div className="grid mt-3">
            <div className="md:col-6 lg:col-6">
              ...
              <Dropdown
                ...
                onChange={(e) =>
                  Provincesform.setFieldValue("countryId", e.value)
                }
              />
            </div>
            <div className="md:col-5 lg:col-5">
              ...
              <InputText
                ...
                onChange={(e) =>
                  Provincesform.setFieldValue("name", e.target.value)
                }
              />
            </div>
          </div>
          ...
          <div className="grid">
            <div className="md:col-6 lg:col-6">
              ...
              <Dropdown
                ...
                onChange={(e) =>
                  ProvinceformEdit.setFieldValue("countryId", e.value)
                }
              />
            </div>
            <div className="md:col-6 lg:col-6">
              ...
              <InputText
                ...
                onChange={(e) =>
                  ProvinceformEdit.setFieldValue("name", e.target.value)
                }
              />
            </div>
          </div>
