...
const Home = () => {
  ...
  const headerNature = <img alt="Card" src={nature1} />;
  const headerNature2 = <img alt="Card" src={nature2} />;
  const headerNature3 = <img alt="Card" src={nature3} />;
  const headerNature4 = <img alt="Card" src={nature4} />;
  const headerIconCar = (
    <img
      alt="Card"
      src={icon1}
      style={{ width: "30%", paddingTop: "40px", paddingLeft: "20px" }}
    />
  );
  const headerIcongps = (
    <img
      ...
      <div className="overflow-hidden">
        <div id="imageContainer">
          <div className="md:col-12 lg:col-12 md:w-full lg:w-full text-center 	">
            <h1 className="mt-6 get-rp">
              {" "}
              Get Your Trip With Ge<span className="secondery">t</span>rip
            </h1>
              ...
              <TabView>
                <TabPanel
                  header={
                    <div>
                      <span>
                        <i className="pi pi-search mr-2"></i> Search All{" "}
                      </span>{" "}
                    </div>
                  }
                >
                ...
                <TabPanel
                  header={
                    <div>
                      <span>
                        <i className="pi pi-building mr-2"></i> Yacht BookingsS{" "}
                      </span>{" "}
                    </div>
                  }
                >
                ...
                <TabPanel
                  header={
                    <div>
                      <span>
                        <i className="pi pi-building mr-2"></i> Restaurants{" "}
                      </span>{" "}
                    </div>
                  }
                >
                ...
                <TabPanel
                  header={
                    <div>
                      <span>
                        <i className="pi pi-car mr-2"></i> Cottages{" "}
                      </span>{" "}
                    </div>
                  }
                >
                ...
                <TabPanel
                  header={
                    <div>
                      <span>
                        <i className="pi pi-caret-down mr-2"></i> Packages{" "}
                      </span>{" "}
                    </div>
                  }
                >
        ...
        <div className="md:ml-7 lg:ml-7 card-container">
          ...
          <div className="card grid gap-3 mb-5">
            ...
            <Card
              ...
              style={{ height: "27rem" }}
              header={headerNature3}
              className="md:w-21rem card"
            >
              <div className=" mb-0">
                <p>
                  {" "}
                  Historic castle ruins with coastal walks and seafood dining.
                </p>
              </div>
            </Card>
            <Card
              ...
              style={{ height: "27rem" }}
              header={headerNature4}
              className="md:w-21rem"
            >
              <div className=" mb-0">
                <p>
                  {" "}
                  Botanical garden with diverse plant species for leisurely
                  strolls.
                </p>
              </div>
            </Card>
