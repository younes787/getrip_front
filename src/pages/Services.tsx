...
<Card title={<div>{s?.name} <i className="pi pi-pencil ml-4"  onClick={() => ShowUser(s)}
/></div> } subTitle={<div style={{color:'white'}}>{s?.description}</div>} className="mt-5 ml-5 mb-5 service-card">
{
...
<Card title='Add New Service' className="mt-5 ml-5 mb-5 service-card" onClick={()=>setShow(true)}>
