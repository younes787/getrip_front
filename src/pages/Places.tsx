    ...
    <div>
      <div>
        ...
        >
          ...
          <Column field="googleMapsUrl" sortable header="Google Maps Url"></Column>
          ...
          <div className="grid mt-3">
            <div className="md:col-6 lg:col-6">
              ...
              <Dropdown
                ...
                onChange={(e) =>
                    Placeform.setFieldValue("cityId", e.value)
                }
              />
            </div>
          ...
          <div className="grid mt-3">
            <div className="md:col-6 lg:col-6">
              ...
              <InputText
                ...
                onChange={(e) =>
                    Placeform.setFieldValue("description", e.target.value)
                }
              />
            </div>
            <div className="md:col-5 lg:col-5">
